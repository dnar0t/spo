...
var PrismaService = function () {
    ...
    var PrismaService = _classThis = /** @class */ (function (_super) {
        ...
        PrismaService_1.prototype.connectWithRetry = function () {
            return __awaiter(this, arguments, void 0, function (maxRetries, delayMs) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 4:
                            error_1 = _a.sent();
                            this.logger.warn("Failed to connect to database (attempt ".concat(attempt, "/").concat(maxRetries, "): ").concat(error_1.message));
                            if (!(attempt < maxRetries)) return [3 /*break*/, 6];
                            this.logger.log("Retrying in ".concat(delayMs, "ms..."));
                            return [4 /*yield*/, new Promise(function (resolve) { return setTimeout(resolve, delayMs); })];
                        case 5:
                            _a.sent();
                            return [3 /*break*/, 7];
                        case 6:
                            this.logger.warn('Could not connect to the database after all retries. ' +
