...
// Контекст для предотвращения двойного AppLayout
const AppLayoutCtx = createContext(false);
...
export function AppLayout({ children }: AppLayoutProps) {
  // Если уже внутри AppLayout — не рендерим второй раз (предотвращает двойную шапку)
  ...
  return (
    <AppLayoutCtx.Provider value={true}>
      <SidebarProvider>
